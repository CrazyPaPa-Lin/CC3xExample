  ...
  return {
    ...
    execute: function () {
      ...
      _export("ScrollViewScene", ScrollViewScene = (_dec = ccclass('ScrollViewScene'), _dec2 = property(_crd && RecyclerView === void 0 ? (_reportPossibleCrUseOfRecyclerView({
        ...
        error: Error()
      }), TestAdapter) : TestAdapter), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        _inheritsLoose(ScrollViewScene, _Component);

        function ScrollViewScene() {
          var _this;
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "recyclerView", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "adapter", _descriptor2, _assertThisInitialized(_this));

          return _this;
        }

        var _proto = ScrollViewScene.prototype;
      ...
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "recyclerView", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
