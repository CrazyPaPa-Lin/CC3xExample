...
import { HorizontalAdapter } from './HorizontalAdapter';
...
@ccclass('HorizontalTestScene')
export class HorizontalTestScene extends Component {
    
    @property(RecyclerView)
    recyclerView:RecyclerView = null;

    @property(HorizontalAdapter)
