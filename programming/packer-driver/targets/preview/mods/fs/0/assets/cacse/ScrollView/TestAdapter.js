System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TestAdapter", TestAdapter = (_dec = ccclass('TestAdapter'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_ref) {
        _inheritsLoose(TestAdapter, _ref);
        ...
        function TestAdapter() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "testNode1", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "testNode2", _descriptor2, _assertThisInitialized(_this));
        ...
        _proto.onCreateViewHolder = function onCreateViewHolder(index) {
          var type = this.getType(index);
          var holder;

          if (type == 0) {
            var node = instantiate(this.testNode1);
            node.active = true;
            holder = new (_crd && TestViewHolder === void 0 ? (_reportPossibleCrUseOfTestViewHolder({
              error: Error()
            }), TestViewHolder) : TestViewHolder)(node);
          } else if (type == 1) {
            var _node = instantiate(this.testNode2);

            _node.active = true;
            holder = new (_crd && TestViewHolder2 === void 0 ? (_reportPossibleCrUseOfTestViewHolder2({
              error: Error()
            }), TestViewHolder2) : TestViewHolder2)(_node);
          }

          return holder;
        };

        _proto.onBindViewHolder = function onBindViewHolder(holder, index) {
          holder.onBind(index);
        };

        _proto.getType = function getType(index) {
          return index % 2;
        };

        return TestAdapter;
      }(_crd && BaseAdapter === void 0 ? (_reportPossibleCrUseOfBaseAdapter({
        error: Error()
      }), BaseAdapter) : BaseAdapter), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "testNode1", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
