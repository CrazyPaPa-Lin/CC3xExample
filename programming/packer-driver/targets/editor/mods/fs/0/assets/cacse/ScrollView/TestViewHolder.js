System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Label, BaseViewHolder, TestViewHolder, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TestViewHolder", TestViewHolder = class TestViewHolder extends (_crd && BaseViewHolder === void 0 ? (_reportPossibleCrUseOfBaseViewHolder({
        error: Error()
